...
int main()
{
	...
	double polarProduct1, polarProduct2, cartesianProduct1, cartesianProduct2;

	if (choice3 == 1){
		if (choice1 == 1){
			//Polar
			dotProd1 = (R)*(number3)*cos(theta - number4);
			cout << "The inner product of v1 and v2 using polar coordinates is " << dotProd1 << endl;
			
			//Cartesian
			dotProd2 = (number1)*(x1) + (number2)*(y1);
			cout << "The inner product of v1 and v2 using Cartesian coordinates is " << dotProd2 << endl;
		}
		else{
			//Polar
			dotProd1 = (number1)*(R1)*cos(number2 - theta1);
			cout << "The inner product of v1 and v2 using polar coordinates is " << dotProd1 << endl;
			
			//Cartesian
			dotProd2 = (x)*(number3) + (y)*(number4);
			cout << "The inner product of v1 and v2 using Cartesian coordinates is " << dotProd2 << endl;
		}
	}
	//Step 12
		...
		if (choice1 == 1){
			//Polar
			polarProduct1 = (R)*(number3);
			polarProduct2 = (theta + number4);
			cout << "\nProduct, polar:\t\tz1 * z2 = " << polarProduct1 << " exp(-j " << polarProduct2 << ")" << endl;
			
			//Cartesian
			cartesianProduct1 = ((number1)*(x1) - (number3)*(y1));
			cartesianProduct2 = ((number1)*(y1) + (x1)*(number3));
			cout << "Product, Cartesian:\tz1 * z2 = " << cartesianProduct1 << " + j " << cartesianProduct2 << endl;
